                  ...
                  <div class="testimonials-section">
                    ...
                    <div class="testimonial-wrapper">
                      ...
                      <div class="testimonial-slider">
                        ...
                        <div class="testimonial">
                          <p class="stars">★★★★</p>
                          <h3>Olivia P. <span class="verified">✔️</span></h3>
                        ...
                        <div class="testimonial">
                          <p class="stars">★★★★</p>
                          <h3>Alex M. <span class="verified">✔️</span></h3>
                        ...
                        <div class="testimonial">
                          <p class="stars">★★★★</p>
                          <h3>Liam K. <span class="verified">✔️</span></h3>
...
.homepage-child {
  ...
  align-items: center;
  /*left: calc(50% - 195px);*/
  width: 400%; /* Largura total no mobile */
  max-width: 200%; /* Limite de largura no desktop */
  height: 900px; /* Altura fixa */
  background-color: #dbd4d4; /* Fundo cinza claro */
...
.banner-promo {
  ...
  left: -1; /* Alinha à esquerda */
  width: 100%; /* Faz o banner ocupar toda a largura */
  background-color: #0f0f0f; /* Cor de fundo preto */
...
/*botão de menu*/
.menu-toggle {
  display: none; /* Mostra o botão de menu */
  background: none;
  border: none;
  font-size: 24px;
  cursor: pointer;
...
.shop-now button {
  display: flex;
  justify-content: center;
  width: 15%; /* Largura total no mobile */
  max-width: 30%; /* Limite de largura no desktop */
...
.estrela2m-sem {
  display: flex;
  position: absolute;
  top: -600px; /* Ajusta a posição vertical */
  width: 50px; /* Define o tamanho da estrela menor */
  left: calc(50% + 50px);
}

.estrela1-sem {
  position: absolute;
  top: -822px; /* Ajusta a altura para ficar alinhada à cabeça do homem */
  left: calc(50% + 544px); /* Move a estrela maior para o lado direito da cabeça */
  width: 90px; /* Define o tamanho da estrela maior */
}
...
/*PRDUTOS- NUMEROS*/
  ...
  .parent {
    ...
    display: flex;
    position: absolute;
    top: 500px; /* Ajusta a posição vertical altura */
    left: calc(50% - 675px);
...
.view-all {
  display: flex;
  justify-content: center;
  width: 20%; /* Largura total no mobile */
  max-width: 50%; /* Limite de largura no desktop */
  background-color: rgb(247, 247, 247); /* Fundo preto */
  color: rgb(0, 0, 0); /* Texto branco */
  padding: 15px 30px; /* Espaçamento interno do botão */
  border: groove; /* Remove a borda padrão */
  border-radius: 150px; /* Bordas arredondadas para criar o efeito oval */
